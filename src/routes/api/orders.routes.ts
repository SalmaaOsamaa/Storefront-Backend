...
orderRoutes.route('/order/current').get(authenticationMiddlware, controllers.CurrentOrders);
orderRoutes.route('/order/completed').get(authenticationMiddlware, controllers.CompletedOrders);
